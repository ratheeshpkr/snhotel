...
vc_map( array(
        "name"      => __( "Reviews Overview", "__x__" ),
        "base"      => "vc_archive_reviews",
...
function x_shortcode_archive_reviews( $atts ) {
	ob_start();
	get_template_part('vc-archive-reviews');
	$returnvariable = ob_get_clean();
	return $returnvariable;
}
 
add_shortcode( 'vc_archive_reviews', 'x_shortcode_archive_reviews' );
...
function new_template_for_vc() {
    ...
    $data['content']    = <<<CONTENT
        [vc_row full_width="stretch_row_content_no_spaces" seperator_indeed_locker="" lk_t="ism_template_1" lk_io="default" lk_dm="0" lk_thm="0" lk_tuo="0" ru_on="0" uhc_on="0" ur_on="0" ref_on="0" el_class="header_template"][vc_column][vc_banner_image][vc_menu][/vc_menu][vc_booking_form][vc_empty_space][/vc_column][/vc_row][vc_row css=".vc_custom_1474611173054{margin-top: 30px !important;}"][vc_column width="2/3"][vc_column_text]
<h3 class="h2-margin">We’re so glad to have you stay</h3>
Sage Hotel West Perth is your modern gateway to the City of Light, right in the heart of West Perth and on the doorstep of the CBD. With good ol’ Aussie customer service that’s all about you, you couldn’t do better than booking a stay with us.

This newly constructed hotel offers modern rooms with homely comforts. Enjoy the <strong>free and fast WiFi</strong> or kick back and watch your 48” flat screen TV. On the healthier side take full advantage of our 24hr gym or get out and about on one of our complimentary bicycles.

While you’re here, why not live it up like the locals do? Picnic at Kings Park and Botanical Gardens, pay a visit to Northbridge’s many pubs and bars, or catch the sunset on one of our pristine white beaches overlooking the Indian Ocean. An experience not to be missed is a day out to the countryside where you’ll savour culinary delights aplenty in Margaret’s River’s world-class wine region. We’re proud to say that in Perth, there’s something for everyone, and we can’t wait to welcome you.

[/vc_column_text][/vc_column][vc_column width="1/3"][vc_review][/vc_column][/vc_row][vc_row full_width="stretch_row" seperator_indeed_locker="" lk_t="ism_template_1" lk_io="default" lk_dm="0" lk_thm="0" lk_tuo="0" ru_on="0" uhc_on="0" ur_on="0" ref_on="0" css=".vc_custom_1469770145062{padding-top: 0px !important;background-image: url(http://snc.staging.snhotels.com/sage-westperth/wp-content/uploads/2016/04/bg_home.png?id=4806) !important;}"][vc_column el_class="row"][vc_custom_heading text="Explore all that we have to offer" font_container="tag:h2|text_align:center" use_theme_fonts="yes" css=".vc_custom_1474610962831{padding-top: 0px !important;padding-bottom: 20px !important;}" el_class="h2-margin"][vc_post_order post_homepage="post_type:snhotel_facility|by_id:1084,1083" post_count="3" post_id="1084,"][/vc_column][/vc_row][vc_row seperator_indeed_locker="" lk_t="ism_template_1" lk_io="default" lk_dm="0" lk_thm="0" lk_tuo="0" ru_on="0" uhc_on="0" ur_on="0" ref_on="0" css=".vc_custom_1469768205521{padding-top: 30px !important;}"][vc_column][vc_featured_offer][/vc_column][/vc_row][vc_row full_width="stretch_row" seperator_indeed_locker="" lk_t="ism_template_1" lk_io="default" lk_dm="0" lk_thm="0" lk_tuo="0" ru_on="0" uhc_on="0" ur_on="0" ref_on="0" css=".vc_custom_1470217426163{padding-top: 0px !important;background-color: #f3f3f3 !important;}"][vc_column][vc_custom_heading text="Hotel Facilities" font_container="tag:h3|text_align:center" use_theme_fonts="yes" css=".vc_custom_1474625271880{margin-bottom: 20px !important;padding-top: 0px !important;}" el_class="H-faci h2-margin"][vc_row_inner el_class="aminity-list"][vc_column_inner width="1/6"][vc_hf_icon icon_text="Lounge" icon_fontawesome="fa fa-glass"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Fitness" icon_fontawesome="fa fa-beer"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Wifi" icon_fontawesome="fa fa-wifi"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Newspapers" icon_fontawesome="fa fa-newspaper-o"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Wheel Chair" style="square" icon_fontawesome="fa fa-wheelchair"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Fax Service" icon_fontawesome="fa fa-fax"][/vc_column_inner][/vc_row_inner][vc_row_inner el_class="aminity-list"][vc_column_inner width="1/6"][vc_hf_icon icon_text="Fax Service" icon_fontawesome="fa fa-fax"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Lounge" icon_fontawesome="fa fa-glass"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Wifi" icon_fontawesome="fa fa-wifi"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Fitness" icon_fontawesome="fa fa-beer"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Wheel Chair" style="square" icon_fontawesome="fa fa-wheelchair"][/vc_column_inner][vc_column_inner width="1/6"][vc_hf_icon icon_text="Newspapers" icon_fontawesome="fa fa-newspaper-o"][/vc_column_inner][/vc_row_inner][vc_empty_space][/vc_column][/vc_row]
CONTENT;
...
function new_template_for_vc_accommodation() {
    ...
    $data['custom_class'] = 'custom_template_for_vc_custom_template'; // CSS class name
    $data['content']    = <<<CONTENT
        [vc_row full_width="stretch_row_content_no_spaces" seperator_indeed_locker="" lk_t="ism_template_1" lk_io="default" lk_dm="0" lk_thm="0" lk_tuo="0" ru_on="0" uhc_on="0" ur_on="0" ref_on="0" el_class="header_template"][vc_column][vc_banner_image][vc_menu][/vc_menu][vc_booking_form][vc_empty_space][/vc_column][/vc_row][vc_row][vc_column width="2/3"][vc_column_text]<h2>Simply a more soothing Stay</h2>
We know how important it is for you to feel right where you belong when you’re on the road for business or leisure, which is why each and every one of our 168 hotel rooms at Sage Hotel™ Wollongong is designed with you in mind.

Enjoy free high speed Wi-Fi Internet access, coffee and tea-making facilities, 40 inch flat screen TV and other in room amenities that will make your stay as easy and familiar as it can be. If there’s anything else you need, we’ll be most happy to help. Because we believe that every little detail in our rooms will turn into a special memory for you.[/vc_column_text][/vc_column][vc_column width="1/3"][/vc_column][/vc_row][vc_row][vc_column][vc_archive_accom taxonomy_loop="order_by:ID|post_type:snhotel_room"][/vc_column][/vc_row]
CONTENT;
...
function new_template_for_vc_facility() {
    ...
    $data['custom_class'] = 'custom_template_for_vc_custom_template'; // CSS class name
    $data['content']    = <<<CONTENT
        [vc_row full_width="stretch_row_content_no_spaces" seperator_indeed_locker="" lk_t="ism_template_1" lk_io="default" lk_dm="0" lk_thm="0" lk_tuo="0" ru_on="0" uhc_on="0" ur_on="0" ref_on="0" el_class="header_template"][vc_column][vc_banner_image][vc_menu][/vc_menu][vc_empty_space][/vc_column][/vc_row][vc_row][vc_column][vc_column_text]Delivering fresh, vibrant and authentic service, Chef Simone Ariano has developed a mouth watering menu with a 21st century twist on traditional Italian food.
Built in 1902 as the Walsh family home we have restored the heritage exterior and refurbished the interior with a modern vintage theme. This beautiful heritage listed building captures Perth history and provides a one of a kind dining atmosphere.
Serving breakfast, lunch and dinner Julio’s has something for everyone. A boutique coffee with freshly baked muffins for breakfast on the go. An express Lunch with colleagues or dinner with friends and family. Whatever the occasion you will be saying bellissimo at the end.[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column][vc_archive_facility taxonomy_loop="post_type:snhotel_facility"][/vc_column][/vc_row]
CONTENT;
...
function new_template_for_vc_destination() {
    ...
    $data['custom_class'] = 'custom_template_for_vc_custom_template'; // CSS class name
    $data['content']    = <<<CONTENT
        [vc_row full_width="stretch_row_content_no_spaces" seperator_indeed_locker="" lk_t="ism_template_1" lk_io="default" lk_dm="0" lk_thm="0" lk_tuo="0" ru_on="0" uhc_on="0" ur_on="0" ref_on="0" el_class="header_template"][vc_column][vc_banner_image primary_title="LOCATION & DIRECTIONS" secondary_title="Discover the easy charms of Wollongong" banner_image="3677"][vc_menu][/vc_menu][vc_booking_form][vc_empty_space][/vc_column][/vc_row][vc_row][vc_column][vc_custom_heading text="Location & Directions" font_container="tag:h3|text_align:left" use_theme_fonts="yes"][vc_gmap url="http://www.snhotels.com/sage/wollongong/" map_image="3670" marker_icon="7113"][/vc_gmap][/vc_column][/vc_row][vc_row][vc_column][vc_column_text]
<h3>Easy Exploration</h3>
As far as location is concerned, Sage Hotel™ Wollongong provides the best of two worlds. Here for leisure? The hotel is the perfect base from which to set off on a different adventure every day. Strictly business? Relish the proximity to a variety of trendy hangouts near the beach. Here are just a few places to explore within a stone’s throw away from the hotel.[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column][vc_archive_dest][/vc_column][/vc_row]
CONTENT;
...
function new_template_for_vc_accommodation_kiridara() {
    ...
    $data['custom_class'] = 'custom_template_for_vc_custom_template'; // CSS class name
    $data['content']    = <<<CONTENT
        [vc_row full_width="stretch_row_content_no_spaces" el_id="banner_accomodation"][vc_column][vc_banner_image][/vc_column][/vc_row][vc_row css=".vc_custom_1468588668776{margin-top: 30px !important;}"][vc_column width="1/3"][vc_column_text]Set amidst the awe-inspiring backdrop of Mount Phou Si and sweet-scented Champa trees, the spacious rooms at Kiridara feature balconies, external terraces and courtyards that let you soak up the stunning natural atmosphere.[/vc_column_text][/vc_column][vc_column width="1/3"][vc_column_text]I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.[/vc_column_text][/vc_column][vc_column width="1/3"][vc_widget_sidebar sidebar_id="accomodation-archive"][/vc_column][/vc_row][vc_row css=".vc_custom_1474535488757{margin-top: 30px !important;margin-right: 0px !important;margin-bottom: 0px !important;margin-left: 0px !important;padding-top: 0px !important;padding-right: 0px !important;padding-bottom: 0px !important;padding-left: 0px !important;}"][vc_column][vc_custom_heading text="OUR ROOMS AND SUITES" font_container="tag:h2|text_align:center" el_class="pageheader"][vc_archive_accom taxonomy_loop="post_type:snhotel_room"][vc_raw_html]JTNDZGl2JTIwY2xhc3MlM0QlMjJibG9jay1zZXByYXRvciUyMiUzRSUzQyUyRmRpdiUzRQ==[/vc_raw_html][/vc_column][/vc_row][vc_row][vc_column][vc_custom_heading text="Related Offers" font_container="tag:h2|text_align:center" el_class="pageheader"][vc_related_offer][/vc_related_offer][/vc_column][/vc_row]
CONTENT;
...
vc_map( array(
	...
	// SNH IBE booking form Shortcode
// =============================================================================
...
/*-------------------------------------------------------------------------------
 Custom SNH IBE archive accomodation
-------------------------------------------------------------------------------*/
vc_map( array(
        "name"      => __( "IBE Accommodation Overview", "__x__" ),
